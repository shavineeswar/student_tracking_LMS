...
<head>
  ...
  <title>Forms / Layouts - Student Profile Tracker</title>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="POST" action="submitfeedback.php" >
                ...
                <div class="row mb-3">
                  <label for="inputEmail3" class="col-sm-2 col-form-label">IndexNo</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail" name="indexno">
                  </div>
                </div>
